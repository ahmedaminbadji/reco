...
<ul class="nav nav-tabs" role="tablist">
    <li class="nav-item nav-link active" ><a role="tab" aria-controls="ajoutDoc" aria-selected="true" data-toggle="tab"  href="#ajoutDoc">Ajouter un enseignant </a></li>
    <li><a data-toggle="tab" class="nav-item nav-link"  href="#listeDoc">Liste des enseignants  </a></li>
    </ul>
    <div class="tab-content">
                    <div id="ajoutDoc" class="tab-pane fade show active">
                        <form action="process/ajouterEns.php" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                            ...
                            <div class="table-responsive">
                                <table id="productsTable" class="table table-bordered" style="text-align:center">
                                    ...
                                    ?>
                                        ...
                                        <td>
                                        <?php 
                                            $query = "SELECT * FROM enseignent WHERE id_utilisateur = ?";
                                            $sql = $pdo->prepare($query);
                                            $sql->execute([$row["id_utilisateur"]]);
                                            $result = $sql->fetch(PDO::FETCH_ASSOC);
                                            echo $result["grade_ens"];
                                          
                                        ?>
                                        </td>
                                        <td><button class="btn btn-info" id="modifierEns" data-toggle="modal" data-id="<?php  echo $row["id_utilisateur"] ?>" data-target="#modifierModal">Modifier</button></td>
                                        <td><a href="process/deleteEns.php?id=<?php echo $row['id_utilisateur'] ?>"><button class="btn btn-danger" >Supprimer</button></a></td>
                                        </tr>
                                        <?php 
                                          }
                                        ?>
...
<div class="modal fade" id="modifierModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="process/editEns.php" method="post" enctype="multipart/form-data">
